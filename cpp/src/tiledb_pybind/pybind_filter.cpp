...
//ignore_templatefunction 	Filter & set_option( tiledb_filter_option_t option, T value)
//ignore_keywords 	Filter & set_option( tiledb_filter_option_t option, const void * value)
